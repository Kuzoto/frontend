...
import { useGroceryLabels, useCreateGroceryLabel, useUpdateGroceryLabel, useDeleteGroceryLabel } from '@/hooks/useGroceries'

export default function GroceryLabelManager() {
  const { data: labels = [] } = useGroceryLabels()
  const createLabel = useCreateGroceryLabel()
  const updateLabel = useUpdateGroceryLabel()
  const deleteLabel = useDeleteGroceryLabel()
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="end" className="w-64">
        <h4 className="font-medium text-sm mb-3">Manage Labels</h4>
